...
//NOTE: A 'base' (the exponent) less than 1.0 would cause the value to decline. Exactly 1.0 would hold it constant. These are not
...
//TODO: Support true Fibonacci on a flag, or as a distinct type, by initializing 'modifier' to zero/
		...
		this._typeName = Progression.LookupTypeName(this._typeEnum);

		this._originalBase = base;
		this._originalModifier = modifier;
...
//NOTE: This call initializes _base, _modifier and _value.
	...
	Reset() {
		...
		this._modifier = this._originalModifier;
