...
//doom
	// ProcessCompletedEpoch(epoch, logs, totalEpochs) {
	// 	this._epochStats.Update(epoch, logs);
	//
	// 	console.log((1 + epoch) + '/' + totalEpochs,
	// 				this._epochStats.WriteReport(),
	// 				'DUR: ' + Utils.WriteDurationReport(DURATION));
	// }

	ResetEpochStats() {
//NOTE: These are currently only used by the reporting callback. However, they will be critical to tracking
