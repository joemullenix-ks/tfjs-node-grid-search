...
const DIGITS_SLOPE = 6;
									...
									const LINE_ACC_LONG = ss.linearRegression(TRAIL_ACC_LONG_AS_COORDS);
									const LINE_LOSS_LONG = ss.linearRegression(TRAIL_LOSS_LONG_AS_COORDS);
									const LINE_VAL_ACC_LONG = ss.linearRegression(TRAIL_VAL_ACC_LONG_AS_COORDS);
									const LINE_VAL_LOSS_LONG = ss.linearRegression(TRAIL_VAL_LOSS_LONG_AS_COORDS);
