...
//TODO: Lift these out into GridOptions. Use the current values as defaults.
const EPOCH_TRAILING_AVERAGE_DEPTH = 5;
const VALIDATION_SIZE_WARNING_THRESHOLD = 100; //TODO: When we make this an option, it becomes fatal (currently just warns).
...
//TODO: log the loss/acc and valloss/valacc and our trailing aves! ...and the run time
...
//NOTE: This is how TF performs the split (ceil()) as of v2.7.0.
		...
		if (TOTAL_VALIDATION_CASES <= VALIDATION_SIZE_WARNING_THRESHOLD) {
			console.warn('Validation split is extremely low, and may not produce useful results.');
		}

		if (TOTAL_TRAINING_CASES <= VALIDATION_SIZE_WARNING_THRESHOLD) {
