...
const tngs = __importStar(require("./main"));
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sessionData = new tngs.SessionData(TEST_DATA_FRACTION, dataSet, true);
    ...
    const grid = new tngs.Grid(axisSet, modelStatics, sessionData, evaluatePrediction, gridOptions);
    yield grid.Run();
});
