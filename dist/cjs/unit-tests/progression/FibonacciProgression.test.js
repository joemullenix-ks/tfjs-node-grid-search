...
test('instantiation; advance and reset', () => {
    expect(() => {
        ...
        const fibonacciProgression = new main_1.FibonacciProgression(INVALID_INITIATOR);
    }).toThrow();
    const fibonacciProgression = new main_1.FibonacciProgression(0);
    expect(fibonacciProgression).toBeInstanceOf(main_1.FibonacciProgression);
...
test('float rounds to proper value', () => {
    const fibonacciProgression = new main_1.FibonacciProgression(2.5);
    expect(fibonacciProgression).toBeInstanceOf(main_1.FibonacciProgression);
    expect(fibonacciProgression.value).toBe(0);
    fibonacciProgression.Advance();
    expect(fibonacciProgression.value).toBe(3);
...
test('midpoint falls to proper value', () => {
    const fibonacciProgression = new main_1.FibonacciProgression(10);
    expect(fibonacciProgression).toBeInstanceOf(main_1.FibonacciProgression);
    expect(fibonacciProgression.value).toBe(0);
    fibonacciProgression.Advance();
...
test('midpoint rises to proper value', () => {
    const fibonacciProgression = new main_1.FibonacciProgression(11);
    expect(fibonacciProgression).toBeInstanceOf(main_1.FibonacciProgression);
    expect(fibonacciProgression.value).toBe(0);
    fibonacciProgression.Advance();
    expect(fibonacciProgression.value).toBe(13);
