...
class Grid {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; !this._axisSetTraverser.traversed; ++i) {
                ...
                for (let r = 0; r < TOTAL_REPETITIONS; ++r) {
                    ...
                    const ITERATION_RESULT = new IterationResult(i, this._axisSetTraverser.LookupIterationDescriptor(i), this._epochStats, MODEL_PARAMS, MODEL_TEST_STATS, r, ITERATION_DURATION);
            ...
            if (this._gridOptions.GetOption('writeResultsAsCSV')) {
                const RESULTS_DIRECTORY = this._gridOptions.GetOption('resultsDirectory');
                const FILENAME = FileIO.ProduceResultsFilename();
                yield FileIO.WriteResultsFile(FILENAME, RESULTS_DIRECTORY, GRID_RUN_STATS.WriteCSV());
    ...
    TestModel(model, modelParams, duration) {
        ...
        const MODEL_TEST_STATS = new ModelTestStats(aggregateDeltaCorrect, aggregateDeltaIncorrect, totalCorrect, PREDICTIONS.length);
