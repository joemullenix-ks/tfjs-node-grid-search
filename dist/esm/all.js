...
const MAIN = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    */
    ...
    const FETCH_DATA = (pathInputs, pathTargets) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield FileIO.ReadDataFile(pathInputs, FILE_RESULT);
        const RAW_INPUTS = JSON.parse(FILE_RESULT.data);
        yield FileIO.ReadDataFile(pathTargets, FILE_RESULT);
    ...
    const SESSION_DATA = new SessionData(PROOF_PERCENTAGE, DATA_PACKAGE.inputs, DATA_PACKAGE.targets, true); // useDefaultStandardization
    ...
    const EVALUATE_PREDICTION = (target, prediction) => {
        ...
        const EVALUATION = new PredictionEvaluation(TARGETTED_INDEX === PREDICTED_INDEX, 1 - PREDICTION_2D[PREDICTED_INDEX]);
        return EVALUATION;
    };
    ...
    try {
        const GRID = new Grid(AXIS_SET, MODEL_STATICS, SESSION_DATA, EVALUATE_PREDICTION, GRID_OPTIONS);
        // REPORT_ITERATION,
        // REPORT_EPOCH,
        // REPORT_BATCH);
        yield GRID.Run();
