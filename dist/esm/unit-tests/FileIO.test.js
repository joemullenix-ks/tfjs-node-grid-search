...
describe('async file read', () => {
    ...
    test('finds file', () => {
        ...
        expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield FileIO.ReadDataFile(PATH_VALID, FILE_IO_RESULT);
        })).not.toThrow();
    });
    ...
    test('throws on bad filepath', () => {
        ...
        return expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield FileIO.ReadDataFile(PATH_INVALID, FILE_IO_RESULT);
        })).rejects.toThrow();
    });
...
describe('async file write', () => {
    ...
    test('does not throw w valid args', () => {
        expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield FileIO.WriteResultsFile(FILE_VALID, '', OUTPUT_DATA);
        })).not.toThrow();
    });
    test('throws on empty filename', () => {
        return expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield FileIO.WriteResultsFile('', '', OUTPUT_DATA);
        })).rejects.toThrow();
    });
    test('throws on bad directory', () => {
        return expect(() => __awaiter(void 0, void 0, void 0, function* () {
            yield FileIO.WriteResultsFile(FILE_VALID, DIRECTORY_INVALID, OUTPUT_DATA);
        })).rejects.toThrow();
    });
    test('returns cleanly', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            expect(yield FileIO.WriteResultsFile(FILE_VALID, '', OUTPUT_DATA)).toBeUndefined();
        }
        catch (e) {
