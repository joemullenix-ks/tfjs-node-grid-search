...
test('adding an iteration result and writing reports', () => {
    ...
    const iterationResultA = new IterationResult(1, 'descriptorA', epochStats, modelParams, modelTestStatsA, 2, 3);
    const gridRunStats = new GridRunStats();
    ...
    const iterationResultB = new IterationResult(2, 'descriptorB', epochStats, modelParams, modelTestStatsB, 4, 5);
