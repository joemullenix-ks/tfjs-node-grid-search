'use strict';
import { Axis, AxisNames, AxisSet, AxisSetTraverser, AxisTypes, ExponentialProgression, FibonacciProgression, LinearProgression } from '../src/main';
...
describe('advance until traversed', () => {
    const linearAxis = new Axis(AxisTypes.BATCH_SIZE, 1, 5, new LinearProgression(4));
    const axes = [];
    axes.push(linearAxis);
    const axisSet = new AxisSet(axes);
    const axisSetTraverser = new AxisSetTraverser(axisSet);
