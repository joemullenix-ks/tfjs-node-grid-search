...
'use strict';
import { Axis, AxisNames, AxisTypes, ExponentialProgression, FibonacciProgression, LinearProgression } from '../src/main';
...
describe('invalid instantiation', () => {
    ...
    test('bad bounds: BATCH_SIZE', () => {
        expect(() => {
            const axis = new Axis(AxisTypes.BATCH_SIZE, 0, 0, new LinearProgression(1));
        }).toThrowError();
    });
});
